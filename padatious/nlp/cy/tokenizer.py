...
from .lemmatizer import add_inflection
...
class WelshTokenizer(object):
    ...
    def add_inflection_to_lemmatizer(self, inflection, lemma):
       add_inflection(inflection, lemma)
    ...
    def tokenize(self, string, lemma):
        ...
        Args:
            ...
            lemmatize(bool): This signifies whether the tokenizer should lemmatize each token
